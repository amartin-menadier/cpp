...
unsigned int	FragTrap::set_hitPoints()
{
	m_hitPoints = 100;
	return (m_hitPoints);
}

unsigned int	FragTrap::set_maxHitPoints()
{
	m_maxHitPoints = 100;
	return (m_maxHitPoints);
}

unsigned int	FragTrap::set_rangedAttackDamage()
{
	m_rangedAttackDamage  = 20;
	return (m_rangedAttackDamage);
}

unsigned int	FragTrap::set_armorDamageReduction()
{
	m_armorDamageReduction = 5;
